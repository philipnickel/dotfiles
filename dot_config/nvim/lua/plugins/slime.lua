...
return {
  ...
  config = function()
    ...
    -- Function to start IPython REPL in WezTerm
...
if _ip:
    ...
    print("✓ Inline plotting enabled (with LaTeX rendering)!")
]]
    ...
    local function send_file()
      ...
      -- Use slime to send the text
      vim.fn['slime#send'](text .. "\n")
    end

    -- Keybindings
    vim.keymap.set('n', '<leader>rp', start_ipython_repl, { desc = 'Start Python REPL' })
    vim.keymap.set('n', '<leader>rr', start_r_repl, { desc = 'Start R REPL' })
